...
function generateValidEmoji(emoji: string) {
  return emoji
    .split('')
...
function getEmojiAndStyle(emoji: string) {
...
export function generateEmojiImageVNode(createElement: typeof h, emoji: string) {
  const [validEmoji, style] = getEmojiAndStyle(emoji);
